...
% Flag für Einfügen des todo Verzeichnis
\newif\iftodoverz
\todoverzfalse
...
\newcommand{\citem}[1]{\it\fiem[\texttt{#1}]} % Code-Item für description-Liste
...
\newcommand{\listingsettings}{%
	\lstset{%
		language=csh,			% Standardsprache des Quellcodes
...
\newcommand{\setpagestylehead}{%
    \fancypagestyle{plain}{%
        ...
        \fancyhead[R]{
            ...
            \iflang{de}{
				\begin{textblock*}{188mm}(-3mm,5mm)    
				%\begin{textblock*}{188mm}(-50mm,9mm)            	
            	\includegraphics[height=1.8cm]{images/dhbw_de}
            	\end{textblock*}
            	}
            \iflang{en}{
...
\usepackage[
    ...
    sortlocale=de_DE,
%    sorting=none,		% wenn nach Reihenfolge des Erscheinens im Text 
    style=\zitierstil,
]{biblatex}
}
\iflang{en}{%
