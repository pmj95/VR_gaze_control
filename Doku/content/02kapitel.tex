...
\chapter{Grundlagen}
\todo[inline]{Also schön ist was anderes :D CM: Meiner meinung nach so i.O.}
...
\todo{erwähnen dass die Brille Trackingpunkte für die Base Stations hat, um Pos.bestimmung zu erlauben; @Clemens: Das macht an der Stelle noch nicht wirklich Sinn. Das wird erst später bei Tracking-System beschrieben}
...
\todo[inline]{Noch darauf eingehen, wie Eye-Tracking technisch funktioniert??? CM: Wenn du motiviert bis, is ja aber grundsätzlich für uns nich allzu relevant. Vlt in ner halben Seite oder so}

\subsection{Eyetracker}
\todo{Blink Detection fehlt noch komplett. Zumindest das Erwähnen}
...
\cite{hmd-eyes-doc.2020} und \cite{hmd-eyes.2020}
...
\todo[inline]{CM: evtl Bild in Anhang? aber länge dürfte so ausreichend sein oder? }
