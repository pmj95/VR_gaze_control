...
\todo[inline]{Bilder formatieren und anpassen}
...
Der Einfluss einer Veränderung kann aufgrund des eingeschränkten Versuchsaufbaus nicht untersucht werden. In diesem Abschnitt würde ein Vergleich in den Zeiten und der Genauigkeit stattfinden. \todo{CM: Unnötig? oder so lassen oder weiter ausformulieren?}
...
\todo{JH: \autoref{fig:plotbuttons} in Anhang schieben wenn sie eine Seite komplett einnimmt? CM: Formatierung auf jeden Fall noch notwendig, da manchmal eine ganze Seite blockiert wird und manchmal nicht. Ansonsten kann immer an der width gespielt werden, bis es nicht mehr alles einnimmt. 80\% scheint ein guter Wert zu sein, muss aber ganz am Ende gemacht werden, da sonst andere sachen verschoben werden. }
\begin{figure}[!htbp]
	\centering
...
\todo{JH: \autoref{fig:plotheatmapprob2} ist doch schon im Anhang vorhanden. Verweise doch direkt darauf. Nimmt eh eine komplette Seite ein... CM: Ich bezieh mich hier hald direkt drauf, deswegen hab ich gedacht dass das schlau is das hier reinzuziehen. Wenn wir bilder rausnehmen rutschen wir evtl auch unter 60 Seiten und das wär ja nich wirklcih geschickt :D}
\begin{figure}[!htbp]
	\centering
