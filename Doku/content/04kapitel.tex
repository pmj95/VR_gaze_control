...
\todo[inline]{Gaze Data Logging hier und Kap 5 CM: hier die aufzeichnung beschreiben, in 5 u 6 die auswertung und interpretation}
\todo[inline,color=red]{JH: Button oder Knopf; bestätigen oder betätigen CM:ich rede von betätigten Knöpfen JH: dann sollten wir da noch einmal drüber reden}
...
Die \autoref{fig:scenes-structure} zeigt exemplarisch die Objektstruktur der Szenen in Unity. Jede Szene hat elf Hauptobjekte, welche teilweise wieder Unterobjekte zugeordnet sind. In der folgenden Aufzählung wird jedes dieser elf Hauptobjekte kurz beschrieben. \todo{macht glaube ich mehr Sinn nur die wichtigsten kurz zu beschreiben}
...
\todo{Gaze Tracker}
Das GameObject \glqq Gaze Tracker\grqq{} ist die Schnittstelle zwischen dem Eyetracker und der \ac{VR}-Umgebung. 

\begin{figure}[!htbp]
	\centering
	\missingfigure{Bild nur von GazeVisualizer}
	\caption[GazeVisualizer]{GazeVisualizer}
